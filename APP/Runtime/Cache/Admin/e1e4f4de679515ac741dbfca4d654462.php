...
<div class="templatemo-content-wrapper">
    <div class="templatemo-content">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo U('Admin/User/index');?>">User info</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="<?php echo U('Admin/User/addUserHandle');?>" role="form" method="post" id="regform">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="请输入邮箱" autocomplete="off">
                    </div>
