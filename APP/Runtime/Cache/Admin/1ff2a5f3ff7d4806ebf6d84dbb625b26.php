...
<div class="templatemo-content-wrapper">
    <div class="templatemo-content">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo U('Admin/Category/index');?>">Cate info</a></li>
            <li class="active">Add Cate</li>
        </ol>
        <h1>Add Category</h1>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <form action="<?php echo U('Admin/Category/addCateHandle');?>" role="form" method="post" id="cateform">
                    <div class="form-group">
                        <label for="name">分类名称</label>
                        <input type="text" class="form-control" name="name" placeholder="分类名称" autocomplete="off">
                    </div>
