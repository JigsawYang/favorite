        ...
        <div class="row margin-bottom-30">
            <div class="col-md-12">
                <ul class="nav nav-pills">
                    <li class="active"><a href="#">用户总数 <span class="badge"><?php echo ($count); ?></span></a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <h4 class="margin-bottom-15">Users</h4>
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                        <?php if(is_array($iuser)): foreach($iuser as $key=>$v): ?><tr>
                                <td><?php echo ($v["id"]); ?></td>
                                <td><?php echo ($v["username"]); ?></td>
                                <td><?php echo ($v["email"]); ?></td>
                                <td><?php echo ($v["loginip"]); ?></td>
                                <td><?php echo (date("Y-m-d", $v["logintime"])); ?></td>
                                <td><a href="<?php echo U('Admin/User/editUser', array('id' => $v['id']));?>" class="btn btn-default btn-primary">Edit</a></td>
                                <td><a href="<?php echo U('Admin/User/delete', array('id' => $v['id']));?>" class="btn btn-danger">Delete</a></td>
