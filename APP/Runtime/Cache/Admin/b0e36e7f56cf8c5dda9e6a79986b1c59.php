        ...
        <div class="row margin-bottom-30">
            <div class="col-md-12">
                <ul class="nav nav-pills">
                    <li class="active"><a href="#">分类总数 <span class="badge"><?php echo ($count); ?></span></a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="btn-group pull-right" id="templatemo_sort_btn">
                    <button type="submit" class="btn btn-default btn-success">Sort</button>
                </div>

                <div class="table-responsive">
                    <h4 class="margin-bottom-15">Category List</h4>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="<?php echo U('Admin/Category/editCate', array('id' => $v['id']));?>">修改</a></li>
                                            <?php if($v["level"] == 3): ?>&nbsp&nbsp&nbsp达到上限分级
                                                <?php else: ?>
                                                <li><a href="<?php echo U('Admin/Category/addCate', array('pid' => $v['id']));?>">添加子分类</a></li><?php endif; ?>
                                        </ul>
                                    </div>
                                </td>
                                <td><a href="<?php echo U('Admin/Category/delete', array('id' => $v['id']));?>" class="btn btn-danger">Delete</a></td>
