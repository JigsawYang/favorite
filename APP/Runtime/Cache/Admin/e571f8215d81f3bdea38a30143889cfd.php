...
<div class="templatemo-content-wrapper">
    <div class="templatemo-content">
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Web</li>
        </ol>
        <h1>Edit Web Info</h1>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <form action="<?php echo U('Admin/Webinfo/editWebHandle', array('id' => $web[0]['id']));?>" role="form" method="post" id="webform">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="网站名字" value="<?php echo ($web[0]['title']); ?>" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="address">网址</label>
                        <input type="text" class="form-control" name="address" placeholder="网址" value="<?php echo ($web[0]['address']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="click">点击次数</label>
                        <input type="text" class="form-control" name="click" placeholder="点击次数" value="<?php echo ($web[0]['click']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="content">网站介绍</label>
                        <textarea class="form-control" rows="8" name="content"><?php echo ($web[0]['content']); ?></textarea>
                    </div>
