                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills">
                                    <li class="active"><a href="#">收集网站总数 <span class="badge"><?php echo ($count); ?></span></a></li>
                                    <li class="active" id="iweather"><a href="#">选择城市获取天气</a></li>

                                    <select name="weather" id="wcode">
                                        <option>请选择</option>
                            ...
                            <div class="templatemo-progress">
                                <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item active">
                                        <h4 class="list-group-item-heading">Top Hot 3 Web</h4>
                                        <?php if(is_array($hot)): foreach($hot as $key=>$v): ?><p class="list-group-item-text"><?php echo ($v["title"]); ?></p><?php endforeach; endif; ?>
                                    </a>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 margin-bottom-30">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">New User Table</div>
                                ...
                                <span class="btn btn-primary"><a href="<?php echo U('Admin/User/index');?>">See Tables</a></span>
                            </div>
                        </div>
                    </div>
                </div>
