...
<div class="templatemo-content-wrapper">
    <div class="templatemo-content">
        <ol class="breadcrumb">
            ...
            <li class="active">Web info</li>
        </ol>
        <h1>Manage Web Info</h1>

        <div class="row margin-bottom-30">
            <div class="col-md-12">
                <ul class="nav nav-pills">
                    <li class="active"><a href="#">网站总数 <span class="badge"><?php echo ($count); ?></span></a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <h4 class="margin-bottom-15">Web Info</h4>
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                        <?php if(is_array($web)): foreach($web as $key=>$v): ?><tr>
                                <td><?php echo ($v["id"]); ?></td>
                                ...
                                <td><a href="<?php echo U('Admin/Webinfo/editWeb', array('id' => $v['id']));?>" class="btn btn-default btn-primary">Edit</a></td>
                                <td><a href="<?php echo U('Admin/Webinfo/toTrash', array('id' => $v['id'], 'type' => 1));?>" class="btn btn-success">To Trash</a></td>
